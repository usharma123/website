    ...
    <div className="flex items-start gap-8 font-base mt-12">
      ...
      <div>
        ...
        <div className="mt-8 text-base sm:text-lg">
          <p>Hi, I am a Master&apos;s student at UPenn&apos;s School of Engineering and Applied Science studying Computer Science and currently working as a software engineer at Xoriant.</p>
